...
const hy4Local: BlogArticle = {
  ...
  cluster: "Tencent Hy4 Preview",
  targetSearchIntent: "Deploy Hy4 Preview with official weights, vLLM or SGLang and realistic hardware caveats",
  targetQuery: "how to run Hy4 Preview locally",
  parentSlug: "tencent-hy4-preview",
  slug: "run-hy4-preview-locally",
  title: "How to Run Hy4 Preview Locally: vLLM, SGLang, FP8 & Hardware",
  metaTitle: "Run Hy4 Preview Locally: vLLM, SGLang, FP8 & Hardware",
  metaDescription: "Use Tencent Hy4 Preview on your own infrastructure with official vLLM and SGLang instructions, FP8 weights, OpenAI-compatible serving and hardware caveats.",
  h1: "How to Run Hy4 Preview Locally with vLLM or SGLang",
  excerpt: "The official full and FP8 weights are self-hostable, but a 770B-total MoE model demands serious multi-GPU planning rather than a consumer-PC recipe.",
  category: "AI",
  author: "Project Monet Editorial Team",
  datePublished: published,
  dateModified: published,
  ogAlt: "Project Monet guide graphic for running Hy4 Preview with vLLM, SGLang and FP8 weights",
  sections: [
    {
      id: "before-you-start",
