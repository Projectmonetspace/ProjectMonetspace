...
export const mercury25Articles: BlogArticle[] = [
  {
    status: "published",
    articleType: "main",
    cluster: "Mercury 2.5 Preview",
    targetSearchIntent: "Understand what Mercury 2.5 Preview is, current access, first-party pricing and context, provider speed claims, API features, use cases and limitations.",
    targetQuery: "Mercury 2.5",
    slug: "mercury-2-5-preview",
    title: "Mercury 2.5 Preview: API, Pricing, Speed & Features",
    metaTitle: "Mercury 2.5 Preview: API, Pricing, Speed & Features",
    ...
    sources: mercurySources,
    relatedPaths: ["/blog/mercury-2-5-api-pricing"],
  },
  {
    status: "published",
    articleType: "supporting",
    cluster: "Mercury 2.5 Preview",
    targetSearchIntent: "Access Mercury 2.5 Preview through OpenRouter, use the correct model slug, understand current pricing and context, and implement it with standard HTTP or the OpenAI SDK.",
    targetQuery: "Mercury 2.5 API",
    parentSlug: "mercury-2-5-preview",
    slug: "mercury-2-5-api-pricing",
    title: "Mercury 2.5 API & Pricing: How to Use It on OpenRouter",
    metaTitle: "Mercury 2.5 API & Pricing: OpenRouter Setup Guide",
    metaDescription: "Use Mercury 2.5 Preview through OpenRouter. See the model slug, current API pricing, context limits, tool support and implementation caveats.",
    h1: "How to Use the Mercury 2.5 API on OpenRouter",
    ...
    datePublished: "2026-09-02",
    dateModified: "2026-09-02",
    ogAlt: "Mercury 2.5 API setup flow through OpenRouter",
    sections: [
      ...
      { id: "request", title: "Make a basic Mercury 2.5 request", blocks: [
        { type: "code", language: "python", code: "import os\nimport requests\n\nresponse = requests.post(\n    \"https://openrouter.ai/api/v1/chat/completions\",\n    headers={\n        \"Authorization\": f\"Bearer {os.environ['OPENROUTER_API_KEY']}\",\n        \"Content-Type\": \"application/json\",\n    },\n    json={\n        \"model\": \"inception/mercury-2.5-preview\",\n        \"messages\": [{\"role\": \"user\", \"content\": \"Summarize this feedback into five themes.\"}],\n    },\n)\nprint(response.json())" },
        { type: "paragraph", html: "OpenRouter-specific attribution headers are optional. Add production timeouts, retries and error handling around the minimal example." },
      ]},
      { id: "openai-sdk", title: "Use Mercury 2.5 with the OpenAI SDK", blocks: [
        { type: "code", language: "python", code: "import os\nfrom openai import OpenAI\n\nclient = OpenAI(\n    base_url=\"https://openrouter.ai/api/v1\",\n    api_key=os.environ[\"OPENROUTER_API_KEY\"],\n)\n\ncompletion = client.chat.completions.create(\n    model=\"inception/mercury-2.5-preview\",\n    messages=[{\"role\": \"user\", \"content\": \"Return three concise landing-page headline ideas.\"}],\n)\nprint(completion.choices[0].message.content)" },
        { type: "paragraph", html: "OpenRouter explicitly documents the OpenAI SDK as a drop-in option when its base URL and API key are used." },
      ]},
    ...
    sources: mercurySources,
    relatedPaths: ["/blog/mercury-2-5-preview"],
  },
];
