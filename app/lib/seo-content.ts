...
const corePagesBase: SeoPage[] = [
  {
    ...
    title: "Web Design for Local and Small Businesses",
    metaTitle: "Web Design for Local & Small Businesses | Project Monet",
    metaDescription: "Professional small-business website design in India and worldwide, with clear pricing, full ownership and a homepage direction before the paid build.",
    ...
    quickAnswer: "Project Monet provides professional website design for local and small businesses in India and internationally. A small free homepage concept can show the visual direction before a paid project begins. Packages start at ₹20,000 for Indian clients and $299 for international clients.",
    kind: "service",
    ...
    sections: [
      ...
      {
        title: "One page or a broader small-business website",
        paragraphs: [
          "A focused one-page website can suit a business with one clear offer, one audience and one main enquiry action. A multi-page website becomes more useful when customers need to compare several services, practitioners, locations, projects or recurring questions.",
          "Page count is not a quality score. Project Monet recommends the smallest structure that explains the business properly, supports the intended search journey and can be kept accurate after launch.",
        ],
      },
    ],
    faqs: [
    ...
    relatedPaths: ["/pricing", "/free-website-demo", "/resources/small-business-website-cost-india", "/resources/web-design-agency-vs-freelancer-india", "/resources/landing-page-vs-website-small-business"],
  },
  {
    path: "/pricing",
...
export const industryPages: SeoPage[] = [
  {
    ...
    metaTitle: "Dental Clinic Website Design in India | Project Monet",
    metaDescription: "Dental clinic website design for India and worldwide, with treatment pages, dentist profiles, mobile appointment paths and responsible patient information.",
    ...
    sections: [
      ...
      { title: "Design the mobile path around a real appointment workflow", paragraphs: ["A patient arriving from Google Maps may need to call, open directions or ask about a treatment immediately. Keep those actions visible without implying that a request is a confirmed appointment.", "If the clinic uses WhatsApp, an external scheduler or a reception callback, the website should describe that handoff accurately. Forms should avoid collecting clinical details the clinic does not need or cannot protect."] },
    ],
    faqs: [
...
const resourcePagesBase: SeoPage[] = [
  {
    ...
    sections: [
      ...
      { title: "One-page, five-page and custom website costs are not interchangeable", paragraphs: ["A one-page website can cover a focused offer, proof and contact path. A five-page website usually adds distinct service, about, work and contact journeys. A custom website may require unique components, data, integrations or operational workflows.", "Ask what each quoted page is responsible for and whether the price includes content preparation, responsive behaviour, forms, analytics, launch support and handover. A page total without deliverables is not a useful comparison."] },
    ...
    faqs: [
      ...
      { question: "How much does a one-page website cost in India?", answer: "Project Monet's focused one-page Starter Website begins at ₹20,000. Other providers may define a one-page scope differently, so compare design, content, integrations, revisions, ownership and recurring costs rather than the headline amount alone." },
    ],
    relatedPaths: ["/pricing", "/resources/website-maintenance", "/resources/web-design-agency-vs-freelancer-india", "/resources/one-page-vs-multi-page-website", "/free-website-demo"],
  },
  {
    ...
    metaDescription: "Do you need a website with a Google Business Profile? Compare discovery, control, local visibility and customer decisions—and why many businesses use both.",
    ...
    sections: [
      ...
      { title: "Does a Google Business Profile replace local-business SEO?", paragraphs: ["No single profile or website page replaces the broader work of being relevant, accurate and trusted. The profile supports Google Maps and local discovery; the website can provide crawlable service, location and decision content that does not fit inside the profile.", "Keep both current. A polished website cannot compensate for incorrect profile hours, and an active profile cannot provide unlimited space for service comparisons, policies, project context or tailored enquiry forms."] },
    ...
    faqs: [
      ...
      { question: "Do I need a website if I already have a Google Business Profile?", answer: "Not to create the profile itself. A website becomes useful when customers need more detail, comparison, proof or a structured enquiry path than the profile can provide." },
    ...
    relatedPaths: ["/services/web-design-for-local-businesses", "/resources/website-vs-instagram", "/resources/landing-page-vs-website-small-business", "/industries/home-services", "/free-website-demo"],
  ...
  },
  {
    ...
    metaTitle: "Website vs Instagram for Small Business | Project Monet",
    metaDescription: "Do you need a website if you have Instagram? Compare discovery, search visibility, control, proof and enquiries—and learn how a small business can use both.",
    ...
    sections: [
      ...
      { title: "When Instagram may be enough for now", paragraphs: ["An early business testing one simple visual offer may reasonably start on Instagram, especially when most demand already comes through relationships or a local audience. The limitation appears when important information is repeatedly buried, customers search Google for the business, or direct messages cannot collect the context needed for a useful enquiry.", "That is usually the point to add a focused website and keep Instagram as the active publishing and discovery channel."] },
    ],
    faqs: [
    ...
    relatedPaths: ["/resources/google-business-profile-vs-website", "/resources/landing-page-vs-website-small-business", "/services/web-design-for-local-businesses", "/industries/salons", "/free-website-demo"],
  },
  {
  ...
  },
  {
    ...
    title: "Website Maintenance Cost in India: What Does It Include?",
    metaTitle: "Website Maintenance Cost in India | Project Monet",
    metaDescription: "Understand website maintenance costs in India, what a plan may include, what stays separate, and Project Monet's published monthly starting prices.",
    ...
    quickAnswer: "Project Monet maintenance starts at ₹1,999 per month for Indian clients and $29 internationally. Website maintenance cost depends on the site, update frequency, software, integrations and support level. It is optional and separate from hosting and the initial build unless a proposal explicitly combines them.",
    kind: "guide",
    updated: "August 28, 2026",
    published: "2026-08-16",
    modified: "2026-08-28",
    sections: [
      ...
      { title: "How to compare monthly and annual maintenance quotes", paragraphs: ["Convert every quote to the same time period, then compare the included work: update allowance, monitoring, backups, response expectations, software costs and exclusions. A low monthly figure may cover only availability, while another plan includes recurring content or technical work.", "Ask whether unused work carries forward, who can approve changes, how urgent issues are handled and what happens to access when the plan ends. Website maintenance, hosting and a future redesign should remain separate line items unless the agreement clearly says otherwise."] },
    ],
    faqs: [
      ...
      { question: "What is the annual cost of Project Monet's Basic Maintenance plan?", answer: "At the published monthly starting rate, twelve months of Basic Maintenance is ₹23,988 or $348 before any separately quoted work or third-party cost. Billing terms and the exact included scope are confirmed in the agreement." },
    ],
    relatedPaths: ["/resources/small-business-website-cost-india", "/pricing", "/website-ownership", "/resources/domain-vs-hosting", "/free-website-demo"],
  },
  {
