...
const expectedSlugs = [
  ...
  "hyper3d-worldgen",
  "hyper3d-worldgen-ai-filmmaking-seedance",
  "writer-enterprise-brain-agent-memory",
  "writer-agent-memory-how-it-works",
  "nimble-ai-sequences",
  "how-to-use-nimble-ai-sequences",
  "suno-v6",
  "how-to-use-suno-v6",
  "suno-v6-vs-v6-wild-vs-v6-mini",
  "noodle-seed",
  "noodle-seed-for-agencies",
  "noodle-seed-developer-guide",
  "adobe-premiere-26-5-generative-media",
  "adobe-premiere-generative-media-tool-guide",
  "adobe-premiere-paper-edit-guide",
  "mastra-factory",
  "mastra-factory-install-self-host",
  "mastra-factory-github-linear-workflow",
  "deepseek-v4-1-flash",
  "deepseek-v4-1-flash-api-pricing-migration",
  "deepseek-v4-1-flash-local-setup",
  "abacus-ai-smaug-agentic-models",
  "smaug-agentic-self-host-vllm-sglang",
  "smaug-flash-api-pricing",
  "fairing-advanced-attribution",
  "fairing-creator-influencer-attribution",
  "fairing-advanced-attribution-setup",
  "gpt-live-1",
  "gpt-live-1-api-guide",
  "gpt-live-1-telephony-voice-agents",
  "adobe-acrobat-productivity-agent",
  "acrobat-ai-pdf-to-presentation",
  "adobe-acrobat-interactive-reports",
  "openrouter-shell-files-api",
  "openrouter-shell-pricing-limits",
  "how-to-use-openrouter-shell-tool",
  "openai-agents-api",
  "openai-agents-api-quickstart",
  "openai-agents-api-sandboxes",
  "openai-agents-api-multi-agent",
  "north-small-translate",
  "run-north-small-translate-locally",
  "north-small-translate-api",
  "meridian-geox",
  "meridian-geox-mmm-calibration",
  "how-to-use-meridian-geox",
  "cursor-projects",
  "cursor-projects-subscriptions",
  "how-to-use-cursor-projects",
  "pinecone-full-text-search",
  "pinecone-full-text-search-tutorial",
  "pinecone-full-text-search-pricing",
  "canva-ai-2-0",
  "canva-code-2-0",
  "canva-ai-2-0-connectors-scheduling",
  "openai-data-agent",
  "chatgpt-data-agent-dashboards",
  "chatgpt-data-agent-setup",
  "runway-model-licensing",
  "runway-model-licensing-vs-api",
  "runway-self-hosted-fine-tuning",
  "elevenlabs-music-v2-5",
  "elevenlabs-music-v2-5-api",
  "elevenlabs-music-v2-5-commercial-use",
  "gemini-windows-app",
  "how-to-use-gemini-windows",
  "sakana-fugu-max-ultra-v2",
  "fugu-max-vs-fugu-ultra-v2",
  "sakana-fugu-max-api-pricing",
  "widgo-ai-sales-rep",
  "widgo-pricing",
  "how-to-use-widgo",
  "instagram-add-tagged-post-to-grid",
  "how-to-add-tagged-post-instagram-grid",
  "socialive-catalyst",
  "frigade-assist-api",
  ...
  "how-to-use-mentionos",
  "llada-image",
  "how-to-run-llada-image-locally",
  "world-labs-atlas-world-model",
  ...
  "how-to-use-tadata",
  "open-yap-1k",
  "open-yap-1k-download-license",
  "vdn-h3-videodeltanet",
  "run-vdn-h3-locally",
  "vdn-h3-license-commercial-use",
  "vdn-h3-comfyui",
  "sembly-3-0-agentic-ai-deliverables",
  "how-to-use-sembly-3-0",
  "minicpm5-2b",
  "minicpm5-2b-local-gguf-ollama-mlx",
  "databox-routines-ai-reporting-automation",
  "wondragents-ai-influencer-marketing",
  "yoroll-h3-superfast-yolive",
  "how-to-use-yolive-ai",
  "fimo-autonomous-website-platform",
  "how-to-use-fimo-claude-code-codex-cursor",
  "minicpm5-2b-vllm-sglang-api-tool-calling",
  "fimo-seo-agents-guide",
  "gupshup-voice-ai",
